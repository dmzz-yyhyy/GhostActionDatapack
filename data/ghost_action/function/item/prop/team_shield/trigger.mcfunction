execute as @s[team=blue] at @s as @a[team=blue,distance=..10] at @s run effect give @s absorption 4 1 false
...
execute as @s[team=red] at @s as @a[team=red,distance=..10] at @s run effect give @s absorption 4 1 true
