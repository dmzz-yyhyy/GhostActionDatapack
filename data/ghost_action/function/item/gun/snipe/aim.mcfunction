...
execute if entity @s[tag=!aim] run attribute @s minecraft:movement_speed modifier add minecraft:aim -0.6 add_multiplied_base
execute if entity @s[tag=!aim] run attribute @s minecraft:jump_strength modifier add minecraft:aim -0.7 add_multiplied_base
