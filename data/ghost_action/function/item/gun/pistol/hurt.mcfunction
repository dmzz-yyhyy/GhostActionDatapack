...
execute at @n[tag=source] if entity @s[distance=..8] run damage @s 5 mob_attack by @n[tag=source]
execute at @n[tag=source] if entity @s[distance=8..60] run damage @s 4 mob_attack by @n[tag=source]
