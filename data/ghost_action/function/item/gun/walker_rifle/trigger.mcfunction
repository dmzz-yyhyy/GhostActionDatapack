...
execute anchored eyes positioned ^ ^ ^0.8 run function ghost_action:utils/racasting/raycasting {\
    ...
    particle1: "minecraft:dust{color: [0.55, 0, 0.66], scale: 0.5}",\
    particle2: "minecraft:dust{color: [0.55, 0, 0.66], scale: 0.5}",\
    on_hit: "ghost_action:item/gun/walker_rifle/hurt",\
    distance: 200\
}
function ghost_action:utils/recoil/recoil {min:35, max:80}