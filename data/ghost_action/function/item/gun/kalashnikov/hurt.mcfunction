...
data modify storage ghost_action:better_hurt_arg damage set value 3.2
execute at @n[tag=source] if entity @s[distance=..8] run damage @s 3.2 mob_attack by @n[tag=source]
execute at @n[tag=source] if entity @s[distance=8..18] run damage @s 2.6 mob_attack by @n[tag=source]
execute at @n[tag=source] if entity @s[distance=18..25] run damage @s 2.1 mob_attack by @n[tag=source]
